...
class User extends CI_Controller {
    ...
    public function add()
    {
        ...
        $this->form_validation->set_message('min_length[8]', '{field} minimal 8 karakter.');
    ...
    public function edit($id)
    {
        ...
        $this->form_validation->set_message('min_length[8]', '%s minimal 8 karakter.');
        $this->form_validation->set_message('is_unique', '%s ini sudah dipakai, silakan ganti.');
